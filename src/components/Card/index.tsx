...
function Card({ alt, logoSource, title, subtitle }: InfoCardType) {
  return (
    <div className="bg-onyx shadow-md lg:[&:not(:last-child)]:flex-1 shadow-blue-munsell text-center rounded-lg h-80 w-full lg:w-80 flex flex-col items-start justify-center lg:justify-between lg:p-9 gap-2 px-6">
